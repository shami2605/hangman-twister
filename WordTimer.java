...
public class WordTimer {
	...
	WordTimer(int startTime) {
		...
		timerButton.setStyle("-fx-font-size: 1.5em;" + "-fx-background-color: white;" + " -fx-background-insets: 0,1,1;"
				+ " -fx-padding: 3 3 3 3;" + " -fx-background-radius: 5em; "
		...
		timeline.getKeyFrames().addAll(new KeyFrame(Duration.seconds(startTime + 1), new KeyValue(timeSeconds, 0)));
